...
class User:
    def __init__(self, username, password, role="user"):
        ...
        self.role = role  # Роль пользователя (по умолчанию - "user")
        self.purchase_history = []  # История покупок
        self.subscription = None  # Статус абонемента
...
class FitnessClub:
    ...
    def view_users(self):
        ...
        # Использование zip для объединения имен пользователей и их статусов абонемента
...
def view_services(fitness_club):
    ...
    if services:
        ...
        # Использование map для получения списка названий услуг и цен
...
def main():
    ...
    # Добавление администратора с ролью "администратор"
    ...
    while True:
        ...
        if choice == '1':
            ...
            if user:
                while True:
                    if user.role == "администратор":  # Проверка роли администратора
                        print("\n1. Добавить услугу")
                    ...
                    else:  # Обычный пользователь действия
